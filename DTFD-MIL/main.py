...
parser.add_argument('--name', default='10-21', type=str)
...
parser.add_argument('--mDATA0_dir_train0', default='/data1/guangyuan/pole/results/feat4DTFD/mDATA_train/train.pkl', type=str)  ## Train Set
parser.add_argument('--mDATA0_dir_val0', default='/data1/guangyuan/pole/results/feat4DTFD/mDATA_train/val.pkl', type=str)      ## Validation Set
parser.add_argument('--mDATA_dir_test0', default='/data1/guangyuan/pole/results/feat4DTFD/mDATA_train/test.pkl', type=str)         ## Test Set
parser.add_argument('--label_file', default='/data1/guangyuan/pole/labels.csv', type=str)
...
parser.add_argument('--distill_type', default='MaxMinS', type=str)   ## MaxMinS, MaxS, AFS
